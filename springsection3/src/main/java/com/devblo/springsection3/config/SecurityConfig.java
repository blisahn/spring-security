package com.devblo.springsection3.config;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        ...
        UserDetails admin = User.withUsername("admin").password("{bcrypt}$2a$12$QpcqRqwQ3QbOL885FNSXPOkB8T/b5EoUyVbkdO3GVNkR1iAZZieCi").authorities("admin").build();
